...
// const bodyParser = require('body-parser'); //BODY Parser - lets us use the req.body
// app.use(bodyParser.urlencoded({ extended: true }));
// app.use(bodyParser.json());

// const mongoose = require('mongoose'); //  MongoDB

// const promise = mongoose.connect('mongodb://localhost/my_db', {
//   useMongoClient: true,
...
// const Question = require('./../models/schema.js');
